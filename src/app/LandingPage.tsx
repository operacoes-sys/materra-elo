...
export default function LandingPage({
  ...
  return (
    <div style={{ background: '#000', color: '#f5f5f5', fontFamily: 'Inter, sans-serif' }}>
      ...
      <section id="corretores" style={{ padding: '80px 20px', background: '#000', borderBottom: '1px solid #111' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '48px', alignItems: 'center' }}>
            ...
            <div>
              ...
              <h2 style={{ fontSize: '2.2rem', fontWeight: 800, color: '#fff', marginTop: '10px', marginBottom: '20px' }}>
                Multiplique seus Resultados como Corretor Homologado
              </h2>
              <p style={{ color: '#aaa', fontSize: '1.05rem', lineHeight: '1.6', marginBottom: '24px' }}>
                A Materra Elo é a maior aliada do Corretor de Resíduos. Nossa plataforma oferece ferramentas exclusivas para você gerenciar clientes representados, intermediar operações e receber relatórios de MTR e CDF sem burocracia.
              </p>
